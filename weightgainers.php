...
<head>
    ...
    <title>Products-Weight Gainers</title>
    <style>
    .card:hover {
...
<body>
    ...
    <div class="container text-center">
        <a href="products.php" type="button" class="btn btn-lg btn-outline-info" title="All products">ALL
            PRODUCTS</a>
        <a href="weightgainers.php" type="button" class="btn btn-lg btn-outline-info bg-dark"
            title="Weight gainers">WEIGHT
            GAINERS</a>
    ...
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT * from products where category='weight' ";

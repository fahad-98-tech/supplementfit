...
<head>
    ...
    <title>Products-Protein Shakes & Powders</title>
    <style>
    .card:hover {
...
<body>
    ...
    <div class="container text-center">
        ...
        <a href="weightgainers.php" type="button" class="btn btn-lg btn-outline-info" title="Weight gainers">WEIGHT
            GAINERS</a>
        <a href="protein.php" type="button" class="btn btn-lg btn-outline-info  bg-dark"
    ...
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT * from products where category='protein' ";
